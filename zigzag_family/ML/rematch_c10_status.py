"""Status report for the zigzag C10 trial-19 high-lifetime verification."""
...
STDOUT_PATH = DATA_DIR / "rematch_c10_trial19_1000h_verify_stdout.log"
STDERR_PATH = DATA_DIR / "rematch_c10_trial19_1000h_verify_stderr.log"
...
def print_process_status():
    command = (
        ...
        "$_.CommandLine -like '*rematch_c10_verify_trial19.py*') -or "
        "($_.Name -like 'comsol*') } | "
...
def print_csv_status():
    ...
    keys = [
        ...
        "z_first_mm", "side_mm", "maxLifetimeCap_h", "maxErosionSteps",
        "lifetimeH", "R_L_pct", "eta_E_pct", "U_pct",
        "lifeTotalP03sphere_J", "failureReached", "capLimited",
        "stepLimited", "erosionSteps", "elapsed_sec",
    ]
    print("csv_last=" + "; ".join(
