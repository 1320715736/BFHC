...
CSV_HEADER = [
    ...
    "initialP03selfAbsorbed_W", "initialSublimationMassRate_kg_s",
    "initialSublimationHeat_W", "initialMaxSublimationHeatFlux_W_m2",
    "initialSublimationHeatToElectric_pct",
    "initialSublimationHeatToGrossRadiation_pct", "lifeAvgP03gross_W",
    ...
    "metricVersion", "physicsVersion", "materialModel",
    "materialUncertaintyVersion", "rhoeScale", "kScale", "cpScale",
    "sublimationHeatEnabled", "sublimationHeatScale",
    "sublimationEnthalpy_J_kg", "sublimationHeatVersion",
    "transientVersion", "geometryVersion",
