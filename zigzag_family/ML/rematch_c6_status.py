"""Status report for the zigzag rematch C6 small search.

This script is read-only. It checks the C6 CSV/SQLite outputs and prints a
...
DB_PATH = DATA_DIR / "rematch_c6_optuna.db"
CSV_PATH = DATA_DIR / "rematch_c6_trials.csv"
