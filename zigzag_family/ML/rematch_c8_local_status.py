"""Status report for the zigzag C8 local Optuna search."""
...
DB_PATH = DATA_DIR / "rematch_c8_local_optuna.db"
CSV_PATH = DATA_DIR / "rematch_c8_local_trials.csv"
STDOUT_PATH = DATA_DIR / "rematch_c8_local_stdout.log"
STDERR_PATH = DATA_DIR / "rematch_c8_local_stderr.log"
...
def print_csv_status():
    ...
    if ok_rows:
        ...
        keys = [
            ...
            "N_RUNS", "L_RUN_mm", "z_first_mm", "side_mm",
            "failureReached", "capLimited",
        ]
        print("best_ok=" + "; ".join(
