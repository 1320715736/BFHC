{
    ...
    // D2 NOTICE: 本 Java Shell 文件冻结在 D1 退蚀近似，仅供历史复现。
    // geometry/lifecycle v2 的唯一权威执行路径是 ../ML/comsol_runner.py；
    // 禁止用本文件生成 D2/E1 评分数据。
    ...
    System.out.println("MODEL_AUTHORITY=LEGACY_D1_ONLY;D2_RUNNER=cylinder_family/ML/comsol_runner.py");
    // ================================================================
